...
Scripts for inspecting and troubleshooting CSDirector project data. This README serves as the script index; add a row and usage notes as more utilities are added.

## Scripts

| Script | Purpose |
| --- | --- |
| [Database and Project File Sync Report](./csdirector-database-project-file-sync-report.ps1) | Compares `.csdproj` archives with SQL Server records and produces linked HTML reports covering truss inventory, selected fields, file checksums, board footage, and suspected duplicate pieces. |
